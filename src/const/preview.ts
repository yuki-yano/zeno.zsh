import { ZENO_GIT_CAT, ZENO_GIT_TREE, ZENO_GIT_STASH_CUT } from "../settings.ts";
...
export const GIT_STASH_PREVIEW = `git stash show -p "$(echo '{}' | ${ZENO_GIT_STASH_CUT})" | ${ZENO_GIT_CAT}`;
